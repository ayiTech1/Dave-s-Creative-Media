...
require_once 'function_service.php'; // Include necessary functions
$message = '';
$error = false;

// Handle form submission
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add_service'])) {
    require_once 'upload_service_handler.php'; // Include the file handling upload logic
}
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Admin - Upload Service</title>
...
<div class="container">
    ...
    <form action="" method="post" enctype="multipart/form-data" id="uploadForm">
        ...
        <div class="form-group">
            <label for="file">Service File</label>
            <input type="file" name="file" id="file" class="form-control" accept="image/*" required>
        </div>
        <button type="submit" name="add_service" class="btn btn-primary">Upload</button>
    </form>
    <?php
    if (!empty($message)) {
