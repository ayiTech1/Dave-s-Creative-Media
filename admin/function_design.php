...
function uploadDesign($file, $conn) {
    $targetDirectory = "../uploads/designs/";
    ...
    if (move_uploaded_file($file["tmp_name"], $targetFile)) {
        ...
        $relativePath = "uploads/designs/" . basename($file['name']);
        $sql = "INSERT INTO designs (title, image_url, description) VALUES (:title, :image_url, :description)";
