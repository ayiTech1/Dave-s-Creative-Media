...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_photo'])) {
    ...
    $sql = "UPDATE galleries SET title = :title, description = :description WHERE id = :id";
    ...
    if ($stmt->execute()) {
        ...
        $updateError = "Error updating gallery.";
    }
}
        ...
        <div class="col-md-12">
            ...
            <div class="form-container">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="btn btn-primary" name="update_photo">Update Gallery</button>
                </form>
            </div>
        </div>
    </div>
